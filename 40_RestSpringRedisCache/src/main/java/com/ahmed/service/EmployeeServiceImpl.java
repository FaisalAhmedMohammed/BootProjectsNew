...
public class EmployeeServiceImpl implements EmployeeService {
	...
	// here we have to write one condition to check the result is not null, if the employee
	// id exist then update, then updated employee should be stored in cache also. other wise return null, so no need to catch
